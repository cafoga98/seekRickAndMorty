...
/// Exception thrown when the location permission is denied.
class NoLocationPermissionException implements Exception {
  final String? message;

  NoLocationPermissionException(this.message);
}

/// Exception thrown when the location permission is denied.
class HandleOperationException implements Exception {
  final OperationException? operationException;

  HandleOperationException(this.operationException);
}
